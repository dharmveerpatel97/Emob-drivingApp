...
import { REGULAR } from '../../utils/fonts';
  ...
  const DropdownComponent = ({ dropdownList,title, onChange,onFocus,selectedValue = null,disabale=false}) => {
    ...
    return (
      <View style={styles.container}>
        <Dropdown
          style={[styles.dropdown, isFocus && { borderColor: color.purpleborders }]}
