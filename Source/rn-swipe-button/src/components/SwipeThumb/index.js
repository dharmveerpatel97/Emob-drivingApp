...
const SwipeThumb = props => {
  ...
  const maxWidth = props.layoutWidth;
    ...
    return (
      <View style={[styles.icon, { ...dynamicStyles}]}>
        {!ThumbIconComponent && thumbIconImageSource && (
          <View>
            <ImageBackground source={require('../../../assets/box.png')} style={{width:thumbIconWidth,height:thumbIconHeight,justifyContent:"center",alignItems:'center'}} resizeMethod="resize">
              <Image source={require('../../../assets/arrow.png')} style={{height:20,width:22}} resizeMode='contain'/>
            </ImageBackground>
          </View>
        )}
        {ThumbIconComponent && (
