...
public class MainActivity extends ReactActivity {
  ...
  protected void onCreate(Bundle savedInstanceState){
    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
      NotificationChannel notificationChannel = new NotificationChannel("default-channel-id", "MirAle", NotificationManager.IMPORTANCE_HIGH);
      ...
      AudioAttributes att = new AudioAttributes.Builder()
              ...
              .build();
      notificationChannel.setSound(Uri.parse(ContentResolver.SCHEME_ANDROID_RESOURCE + "://" + getPackageName() + "/raw/notify_ring"), att);
